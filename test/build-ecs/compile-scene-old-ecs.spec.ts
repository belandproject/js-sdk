...
describe('legacy beland-ecs sanity checks', () => {
  ...
  describe(`beland-ecs@${version}`, () => {
    ...
    it('ensure it uses not minified versions in .lib', () => {
      ...
      expect(lib).toContain(
        resolve(cwd, 'node_modules/beland-ecs/artifacts/amd.js')
      )
      expect(lib).toContain(
        resolve(cwd, 'node_modules/beland-ecs/dist/src/index.js')
      )
    })
  })
}
